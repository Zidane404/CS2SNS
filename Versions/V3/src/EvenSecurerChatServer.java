...
public class EvenSecurerChatServer {
    ...
    private static final ExecutorService threadPool = Executors.newFixedThreadPool(MAX_USERS);

    public static void main(String[] args) {
        System.out.println("=== Secure Chat Server (SSL/TLS) Started ===");
        System.out.println("Listening on port: " + PORT);
        System.out.println("Max User Chatroom Limit: " + MAX_USERS);
